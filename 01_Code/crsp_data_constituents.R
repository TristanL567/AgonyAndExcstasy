...
## Directories.
## AgonyAndExcstasy layout: CRSP processed inputs are in 02_Data_Input/01_CRSP/Necessary/
Data_Directory      <- file.path(Path, "02_Data_Input")
Data_CRSP_Directory <- file.path(Data_Directory, "01_CRSP", "Necessary")
