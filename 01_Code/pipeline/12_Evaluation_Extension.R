...
## Figure directory — index diagnostics live under 4_IndexConstruction_Results
FIG_EVAL <- file.path(DIR_INDEX_FIGS_TRACK, "12_evaluation")
...
port_returns  <- readRDS(PATH_INDEX_RETURNS)
port_perf     <- readRDS(PATH_INDEX_PERF)
port_weights  <- readRDS(PATH_INDEX_WEIGHTS)
excl_summary  <- readRDS(PATH_INDEX_EXCLUSION_SUMMARY)
