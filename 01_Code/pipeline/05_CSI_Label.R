...
stop(
  "[05_CSI_Label.R] Deprecated. Use 05A_Dynamic_CSI_Label.R + ",
  "05B_Permanent_Capital_Loss.R + 05C_Combined_Label.R. ",
  "The legacy script uses the old CSI methodology and must not overwrite ",
  "the revised dynamic/permanent label tracks."
)
