...
# ── Paths ─────────────────────────────────────────────────────────────────────
# AgonyAndExcstasy layout. This file is 01_Code/subfunctions/08B_Autoencoder.py
# so parents[2] points at the repository root.
ROOT          = Path(__file__).resolve().parents[2]   # AgonyAndExcstasy/

import os as _os
_track = _os.environ.get("RESPONSE_TRACK", "dynamic_csi")
_track_folder = "temporary_csi" if _track == "dynamic_csi" else _track

DIR_DATA_INPUT  = ROOT / "02_Data_Input"
DIR_DATA_OUTPUT = ROOT / "03_Data_Output"
DIR_FEATURES    = DIR_DATA_INPUT / "05_PipelineResults" / "Necessary" / _track_folder / "Features"

_DIR_MODELLING_TRACK = DIR_DATA_OUTPUT / "3_Modelling_Results" / "Necessary" / _track_folder
DIR_FIGURES   = _DIR_MODELLING_TRACK / "figures" / "08_autoencoder"
DIR_MODELS    = _DIR_MODELLING_TRACK / "VAE"
...
PATH_FEATURES_LATENT = DIR_FEATURES / "features_latent_fund.parquet"  # was features_latent.rds
