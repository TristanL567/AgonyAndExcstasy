...
\begin{frame}{Temporary CSI: Error-Cost Decomposition}
\fontsize{5.65pt}{6.2pt}\selectfont
\textbf{OOS alpha decomposition for the selected temporary-CSI best strategies}
\vspace{-0.25em}
\begin{table}[ht]
\centering
...
\end{alertblock}
\scriptsize
FP and FN are opportunity-cost terms; TP and TN are gains versus the matched benchmark decomposition. Net matches the selected OOS strategy alpha before cost overlays.
...
\begin{frame}{Permanent CSI: Error-Cost Decomposition}
\fontsize{5.65pt}{6.2pt}\selectfont
\textbf{OOS alpha decomposition for the selected permanent-CSI best strategies}
\vspace{-0.25em}
\begin{table}[ht]
\centering
\setlength{\tabcolsep}{1.65pt}
