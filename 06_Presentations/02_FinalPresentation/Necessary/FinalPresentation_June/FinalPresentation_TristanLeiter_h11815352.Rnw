...
\centering
\setlength{\tabcolsep}{2.0pt}
\begin{tabular}{L{1.25cm}L{1.35cm}R{0.78cm}L{1.85cm}}
\toprule
Track & Lead family & Mean alpha & Interpretation \\
\midrule
Temp. & Youden & +0.35pp & Strongest with 3--5yr lockouts \\
Perm. & FPR3/FPR5 & +0.35/+0.33pp & Fixed-FPR dominates; Youden is -0.20pp \\
\bottomrule
\end{tabular}
\end{table}
\vspace{0.15em}
\scriptsize
Temporary CSI benefits from calibrated finite lockouts; 3- and 5-year exclusions are more effective than 1-year exclusions. Permanent CSI needs stricter fixed-FPR rules because Youden over-removes under absorbing exclusion.
\end{column}
\begin{column}{0.48\textwidth}
...
\scriptsize
\begin{itemize}
  \item Headline winners: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/final\_tables/headline\_winners\_20bps.csv}
  \item Presentation tables: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/final\_tables/presentation\_headline\_tables.md}
  \item Transaction costs: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/final\_tables/transaction\_cost\_robustness\_summary.csv}
  \item Threshold families: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/final\_tables/threshold\_family\_summary\_20bps.csv}
  \item Turnover: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/final\_tables/winner\_turnover\_summary\_20bps.csv}
  \item Full grid comparisons: \texttt{03\_Data\_Output/7\_IndexConstructionValidation/nonraw\_index\_suite/comparison/best\_by\_track\_index\_cost.csv}
\end{itemize}
\vspace{0.3em}
