...
\begin{frame}{Appendix A8: VAE Architecture Details}
\scriptsize
\begin{table}[ht]
\centering
...
\begin{frame}{Appendix A9: Temporary CSI CV/Test/OOS Model Metrics}
\fontsize{4.85pt}{5.35pt}\selectfont
...
\begin{frame}{Appendix A10: Permanent CSI CV/Test/OOS Model Metrics}
\fontsize{4.85pt}{5.35pt}\selectfont
\renewcommand{\arraystretch}{0.78}
\setlength{\tabcolsep}{1.8pt}
\textbf{Full model-suite threshold metrics} {\scriptsize \quad Train/CV, test, and OOS; AP/AUC/FPR recall.}
...
\begin{frame}{Appendix A11: Model Family Winners}
\scriptsize
...
\begin{frame}{Appendix A12: Model Metric Caveats and OOS Robustness}
\scriptsize
...
\begin{frame}{Appendix A13: Final Index Grid Contract}
\scriptsize
\begin{columns}[T,onlytextwidth]
\begin{column}{0.50\textwidth}
...
\begin{frame}{Appendix A14: 20 bps Winners With Benchmarks}
...
\begin{frame}{Appendix A15: Error Decomposition and Index Source Paths}
\scriptsize
...
\begin{frame}{Appendix A18: Temporary CSI Sensitivity Detail}
\fontsize{5.55pt}{6.05pt}\selectfont
...
\begin{frame}{Appendix A19: CV Metrics Versus Index Alpha}
...
\begin{frame}{Appendix A20: Future Robustness and Extensions}
\scriptsize
...
\begin{frame}{Appendix A21: Slide-to-Source Audit Map}
\scriptsize
